...
{
    RHI_TEXTURE_USAGE_TRANSFER_SRC_BIT = 1 << 0,
    RHI_TEXTURE_USAGE_TRANSFER_DST_BIT = 1 << 1,
    RHI_TEXTURE_USAGE_SAMPLED_BIT = 1 << 2,
    RHI_TEXTURE_USAGE_STORAGE_BIT = 1 << 3,
    RHI_TEXTURE_USAGE_COLOR_ATTACHMENT_BIT = 1 << 4,
    RHI_TEXTURE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT = 1 << 5,
    RHI_TEXTURE_USAGE_TRANSIENT_ATTACHMENT_BIT = 1 << 6,
    RHI_TEXTURE_USAGE_INPUT_ATTACHMENT_BIT = 1 << 7,
    RHI_TEXTURE_USAGE_FRAGMENT_DENSITY_MAP_BIT_EXT = 1 << 8,
    RHI_TEXTURE_USAGE_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR = 1 << 9,
    RHI_TEXTURE_USAGE_INVOCATION_MASK_BIT_HUAWEI = 1 << 9,
